...
# --> BaseModel 상속하여 스키마기반 데이터구조를 정의
# --> 타입 힌트를 단순 문서 수준이 아니라 런타임에서 실제 검사까지 진행
...
user1 = User(id='a',name='홍길동', email='test@example.com')
print(user1)
...
# --> 타입 힌트 기반으로 자동 검증, 데이터 입력시 자동 변환 기능이 있다.