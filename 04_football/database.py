...
# sessionmaker : "세션 공장"을 만들어 주는 함수
#                   이 공장에서 세션을 하나씩 찍어내서 (SessionLocal()) DB와 대화 한다.
# 
# os.getenv('DATABASE_URL', 기본값) : 환경변수 DATABASE_URL이 설정되어있으면
#                                      그 값을 사용하고, 없으면 두번째 인자 (기본값)을 사용
